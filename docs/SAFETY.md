...
4. Fully quit Codex Desktop. Closing only the visible window may leave a process running.
5. Run `apply` with the same mapping and behavioral options used for the reviewed plan.
